...
<!-- phone number
  <input id="phone" onfocus="this.value='+91'" onclick="phone_color()" onkeypress="return onlyNumberKey(event)" style="background-image: url('/img/cell_phone.png');margin-top:30px;margin-left:20px;outline:none;text-indent:45px" maxlength="13" autocomplete="off" type="text" placeholder="Mobile Number" required><br>


  <input id="otp" onclick="otp_color()" onkeypress="return onlyNumberKey(event)" style="background-image: url('/img/otp.png');margin-top:30px;margin-left:20px;outline:none;text-indent:45px;width:65%;" maxlength="6" autocomplete="off" type="text" placeholder="Varification Code" required>
  <button style="width:auto;outline:none;" class="reg_btn">OTP</button>

  <input id="pwd"  onclick="pwd_color()" style="background-image: url('/img/key.png');margin-top:30px;margin-left:20px;outline:none;text-indent:45px" maxlength="10" autocomplete="off" type="password" placeholder="Password" required><br>


  <input id="rcode"  onclick="rcode_color()" style="background-image: url('/img/gift_card.png');margin-top:30px;margin-left:20px;outline:none;text-indent:45px" maxlength="10" autocomplete="off" type="text" placeholder="Recommendendation Code" required><br><br>

  <input style="margin-left:25px;" type="checkbox"><b style="color:black;font-size=5px;">I read and agree to  </b><a href="home.html" style="text-decoration:none;color:purple;"> Terms & Conditions</a>

  <p style="text-align:center;margin-top:30px;">
  <input type="button" style="width:250px;outline:none;"  class="recharge_btn" value="Register" onclick="location.href='login.html';">
  </p>
